...
function wpcf7_text_form_tag_handler(WPCF7_FormTag $tag): string {
    ...
    if (in_array($tag->basetype, ['email', 'url', 'tel'], true)) {
...
function wpcf7_text_messages($messages) {
    return array_merge($messages, [
        'invalid_email' => [
            ...
            'default' => __('Please enter an email address.', 'contact-form-7'),
        ],

        'invalid_url' => [
            'description' => __('URL that the sender entered is invalid', 'contact-form-7'),
            'default' => __('Please enter a URL.', 'contact-form-7'),
        ],

        'invalid_tel' => [
            'description' => __('Telephone number that the sender entered is invalid', 'contact-form-7'),
            'default' => __('Please enter a telephone number.', 'contact-form-7'),
        ],
    ]);
}
...
function wpcf7_add_tag_generator_text(): void {
    ...
    $tag_generator->add(
        'url',
        __('URL', 'contact-form-7'),
        'wpcf7_tag_generator_text'
    );
    $tag_generator->add(
        'tel',
        __('tel', 'contact-form-7'),
        'wpcf7_tag_generator_text'
    );
}

function wpcf7_tag_generator_text($contact_form, $args = ''): void {
...
<?php if (in_array($type, ['text', 'email', 'url'], true)) : ?>
	<tr>
