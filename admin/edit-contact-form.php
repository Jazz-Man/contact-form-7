...
function wpcf7_admin_save_button($post_id): void {
    static $button = '';
...
<form method="post" action="<?php echo esc_url(add_query_arg(['post' => $post_id], menu_page_url('wpcf7', false))); ?>" id="wpcf7-admin-form-element"<?php do_action('wpcf7_post_edit_form_tag'); ?>>
<?php
    if (current_user_can('wpcf7_edit_contact_form', $post_id)) {
