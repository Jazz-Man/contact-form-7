...
function wpcf7_sendinblue_doi_register_agent(): void {
    ...
    doihelper_register_agent('wpcf7_sendinblue', [
 ...
 */
function wpcf7_sendinblue_doi_default_optin_callback($properties): void {
    ...
    if (!empty($properties['contact'])) {
        ...
        if ($contact_id && !empty($properties['email'])) {
 ...
 * @param mixed $args
 */
function wpcf7_sendinblue_doi_default_email_callback($args): void {
