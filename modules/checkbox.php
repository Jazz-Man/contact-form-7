...
add_action(
    'wpcf7_admin_init',
    'wpcf7_add_tag_generator_checkbox_and_radio',
    30,
    0
);
...
function wpcf7_add_tag_generator_checkbox_and_radio(): void {
    ...
    $tag_generator->add(
        'radio',
        __('radio buttons', 'contact-form-7'),
        'wpcf7_tag_generator_checkbox'
    );
}

function wpcf7_tag_generator_checkbox($contact_form, $args = ''): void {
