 ...
 * @param mixed $old_ver
 */
function wpcf7_upgrade_recaptcha_v2_v3($new_ver, $old_ver): void {
    ...
    if (!$service->is_active() || $service->get_global_sitekey()) {
        return;
    }
 ...
 * @param mixed $object
 */
function wpcf7_admin_warnings_recaptcha_v2_v3($page, $action, $object): void {
