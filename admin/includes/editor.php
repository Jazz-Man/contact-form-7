...
function wpcf7_editor_panel_form($post): void {
...
function wpcf7_editor_panel_mail($post): void {
...
function wpcf7_editor_box_mail($post, $args = ''): void {
...
function wpcf7_editor_panel_messages($post): void {
    $desc_link = wpcf7_link(
...
function wpcf7_editor_panel_additional_settings($post): void {
    $desc_link = wpcf7_link(
