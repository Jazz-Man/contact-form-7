 ...
 */
function wpcf7_constant_contact_save_contact_form(WPCF7_ContactForm $contact_form): void {
    $service = WPCF7_ConstantContact::get_instance();
...
function wpcf7_constant_contact_editor_panels(array $panels) {
    ...
    $editor_panel = function () use ($prop, $service): void {
        $description = sprintf(
            esc_html(
            ...
            foreach ($lists as $list) {
                echo sprintf(
                    ...
                    wpcf7_format_atts([
                        ...
                        'value' => $list['list_id'],
                        'checked' => in_array($list['list_id'], $prop['contact_lists'], true),
                    ]),
                    esc_html($list['name'])
                );
            }
