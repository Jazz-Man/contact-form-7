...
function wpcf7_captcha_validation_filter($result, $tag) {
    ...
    if ('' === $prefix
    || !wpcf7_check_captcha($prefix, $response)) {
...
function wpcf7_captcha_ajax_refill($items) {
    ...
    $tags = wpcf7_scan_form_tags(['type' => 'captchac']);
...
function wpcf7_add_tag_generator_captcha(): void {
...
function wpcf7_captcha_display_warning_message($page, $action, $object): void {
