 ...
 */
function wpcf7_constant_contact_doi_register_agent(): void {
    if (!function_exists('doihelper_register_agent')) {
        return;
    }

    doihelper_register_agent('wpcf7_constant_contact', [
 ...
 */
function wpcf7_constant_contact_doi_default_optin_callback($properties): void {
 ...
 */
function wpcf7_constant_contact_doi_default_email_callback(array $args): void {
    if (!isset($args['token']) || !isset($args['email_to'])) {
        return;
    }
