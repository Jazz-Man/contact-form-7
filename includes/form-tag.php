...
class WPCF7_FormTag implements ArrayAccess {
     ...
     *
     * @return array|bool|string The option value or an array of option values.
     ...
     *
     * @param array|string $default_classes Optional. Preset classes as an array
     *                                      or a whitespace-separated list. Default empty string.
     *
     * @return bool|string A whitespace-separated list of classes.
     ...
     *
     * @return bool|string The option value in YYYY-MM-DD format. False if the
     ...
     *
     * @param array|string $default_value optional default value
     * @param array|string $args          optional options for the option value retrieval
     *
     * @return array|string The option value. If the multiple option is enabled,
